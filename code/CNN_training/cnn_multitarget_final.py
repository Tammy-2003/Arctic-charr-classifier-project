...
OUTPUT_DIR      = BASE_DIR / "cnn_multitarget_out_v4"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

MODEL_SAVE_PATH = OUTPUT_DIR / "cnn_v4.model"
CONFUSION_MATRIX_CSV = OUTPUT_DIR / "confusion_matrix_v4.csv"
TAG = "v4"
...
model.train(
    train_df,
    validation_df=val_df,   # FIX: was test_df — that leaked the test set into model selection
    steps=total_steps,
...
# model.predict() returns raw logits (pre-sigmoid), not probabilities —
